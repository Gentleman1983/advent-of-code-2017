...
plugins {
    ...
    id("java-library")
    alias(aoc2017Libs.plugins.kotlin.jvm) apply false
    alias(aoc2017Libs.plugins.sonarqube.plugin)
}
...
configure<SonarExtension> {
    properties {
        ...
        property("sonar.projectKey", "de.havox_design.aoc:advent_of_code2017")
